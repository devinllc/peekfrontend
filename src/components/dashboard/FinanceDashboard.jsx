...
import { FiTrendingUp, FiDollarSign, FiUsers, FiBarChart2, FiActivity, FiCpu, FiMessageSquare } from 'react-icons/fi';
import {
        ...
        <>
            ...
            >
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                    ...
                    {analysis.insights.trends?.financial_health_over_time?.Date &&
                     Array.isArray(analysis.insights.trends.financial_health_over_time.Date) &&
                     Array.isArray(analysis.insights.trends.financial_health_over_time.Health_Score) &&
                     analysis.insights.trends.financial_health_over_time.Date.length > 0 &&
                     analysis.insights.trends.financial_health_over_time.Health_Score.length === analysis.insights.trends.financial_health_over_time.Date.length && (
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ delay: 0.1 }}
                        ...
                        >
                            ...
                            <div className="h-[400px] w-full">
                                <ResponsiveContainer width="100%" height="100%">
                                    <AreaChart
                                        data={analysis.insights.trends.financial_health_over_time.Date.map((date, index) => ({
                                            date: new Date(date).toLocaleDateString('en-US', { month: 'short', day: 'numeric' }),
                                            score: analysis.insights.trends.financial_health_over_time.Health_Score[index]
                                        }))}
